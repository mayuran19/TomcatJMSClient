package com.bcsis.g3.tomcat.jmx.client;
...
public class Client {
	...
	public static void main(String[] args) throws Exception {
		...
		JMXServiceURL url = new JMXServiceURL(
				"service:jmx:rmi:///jndi/rmi://:6666/jmxrmi");
		String[] creds = {"controlRole", "tomcat"};
		...
		ObjectName objName = new ObjectName("Catalina:j2eeType=WebModule,name=//localhost/axis,J2EEApplication=none,J2EEServer=none");
		System.out.println(objName);
		mbsc.addNotificationListener(objName, listener, null, null);
		Object o = mbsc.invoke(objName, "stop", null, null);
		ContextMBean mbeanProxy = JMX.newMBeanProxy(mbsc, objName, ContextMBean.class, true);
		Object obj = mbeanProxy.invoke("stop", null, null);
